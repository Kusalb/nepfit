...
<div class="row">
    <div class="col-lg-3">
        <g:link action="event_edit" id="${events.id}"> <i class="fa fa-edit"></i></g:link>

    </div>
    <div class="col-lg-4">
        <g:link action="delete" id="${events.id}" onclick="return confirm('Are u sure?')"><i class="fa fa-trash"></i>
