                ...
                <g:link controller="products" action="showproduct" id="${products?.id}">
                        ...
                        <div class="card-body">
                            <div class="news-title">
                                ...
                                <p class="card-text"><small class="text-time"><em>Price: ${products.price}</em></small></p>
                        ...
                        <sec:ifAnyGranted roles="ROLE_ADMIN">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <g:link action="delete" id="${products.id}" onclick="return confirm('Are u sure?')"><i class="fa fa-trash"></i>Delete
